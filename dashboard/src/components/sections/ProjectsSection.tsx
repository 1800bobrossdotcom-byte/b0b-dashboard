...
export function ProjectsSection() {
  const projects = [
    ...
    },
    {
      ...
      status: 'live',
      stack: ['Next.js', 'Base', 'Polymarket'],
    },
    {
      name: 'LIVE TRADER',
      description: 'Autonomous trading with Bankr SDK. $50k+ liquidity only.',
      url: '/labs',
      status: 'live',
      stack: ['Bankr', 'x402', 'Base'],
    },
    {
      name: 'CRAWLERS',
    ...
    {
      name: 'TEAM AGENTS',
      description: 'b0b, r0ss, c0m — Multi-agent coordination. The swarm.',
      url: '/labs',
      status: 'live',
      stack: ['MCP', 'Claude'],
    },
